...
public class FilepathManager {
    ...
    public static String getFilePath(Context context, Uri uri){
        ...
        if(DocumentsContract.isDocumentUri(context,uri)) {  //如果是document类型的uri,则通过document id处理
            ...
            if ("com.android.providers.media.documents".equals(uri.getAuthority())) {
                ...
                filePath = getImagePath(context, MediaStore.Images.Media.EXTERNAL_CONTENT_URI, selection);
    ...
    public static String getFilePath2(Context context,Uri uri){
        if(uri == null){
            return null;
        }
        ...
        if(scheme == null){
            ...
            if(cursor != null){
                Log.i("aaa","cursor = " + cursor.getCount());
                if (cursor.moveToFirst()){
                    //Log.i("aaa","cursor1111 = " + cursor.getString(0));
                    int i = cursor.getColumnIndex(MediaStore.Images.Media.DATA);
                    if(i > -1){
